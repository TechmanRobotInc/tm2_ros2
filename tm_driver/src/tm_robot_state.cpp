...
public:
  TmDataTable(TmRobotState *rs)
  {
    ...
    _item_map["Ctrl_DO8"] = {&rs->tmRobotStateDataFromEthernet.ctrller_DO[8]};
    _item_map["Ctrl_DO9"] = {&rs->tmRobotStateDataFromEthernet.ctrller_DO[9]};
    _item_map["Ctrl_DO10"] = {&rs->tmRobotStateDataFromEthernet.ctrller_DO[10]};
    _item_map["Ctrl_DO11"] = {&rs->tmRobotStateDataFromEthernet.ctrller_DO[11]};
    _item_map["Ctrl_DO12"] = {&rs->tmRobotStateDataFromEthernet.ctrller_DO[12]};
    _item_map["Ctrl_DO13"] = {&rs->tmRobotStateDataFromEthernet.ctrller_DO[13]};
    _item_map["Ctrl_DO14"] = {&rs->tmRobotStateDataFromEthernet.ctrller_DO[14]};
    _item_map["Ctrl_DO15"] = {&rs->tmRobotStateDataFromEthernet.ctrller_DO[15]};
    ...
    _item_map["Ctrl_DI8"] = {&rs->tmRobotStateDataFromEthernet.ctrller_DI[8]};
    _item_map["Ctrl_DI9"] = {&rs->tmRobotStateDataFromEthernet.ctrller_DI[9]};
    _item_map["Ctrl_DI10"] = {&rs->tmRobotStateDataFromEthernet.ctrller_DI[10]};
    _item_map["Ctrl_DI11"] = {&rs->tmRobotStateDataFromEthernet.ctrller_DI[11]};
    _item_map["Ctrl_DI12"] = {&rs->tmRobotStateDataFromEthernet.ctrller_DI[12]};
    _item_map["Ctrl_DI13"] = {&rs->tmRobotStateDataFromEthernet.ctrller_DI[13]};
    _item_map["Ctrl_DI14"] = {&rs->tmRobotStateDataFromEthernet.ctrller_DI[14]};
    _item_map["Ctrl_DI15"] = {&rs->tmRobotStateDataFromEthernet.ctrller_DI[15]};
