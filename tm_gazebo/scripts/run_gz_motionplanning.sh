...
########################################################
# This script demo the tm12s cobot on the Gazebos GUI. #
########################################################
...
echo ""
echo "******************************************************"
echo "Prepare to run TM12S Cobot on Gazebo GUI and RVIZ2 ..."
echo "******************************************************"
...
echo ""
echo "**************************************************************************"
echo "If tm12s_gazebo demo works fine, press CTRL + C to shut everything down..."
echo "**************************************************************************"
CURRENT_TIME=$(date +"%T")
...
# Running the tm12s demo file
ros2 launch tm12s_moveit_config tm12s_run_move_group_gz.launch.py
