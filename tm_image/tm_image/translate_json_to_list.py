...
class TmJsonToDiction:
    ...
    def json_to_dict(jsonString):
        json_array = json.loads(jsonString)
        returnDictionary = {}
...
if __name__ == '__main__':
    ...
    jsonString = TmJsonToDiction.tm_string_to_json(inputStr)
    print(jsonString)
    dictionary = TmJsonToDiction.json_to_dict(jsonString)
    print(dictionary)
    ...
    nokori, newString = TmJsonToDiction.split_package(inputStr2)
    ...
    nokori, newString = TmJsonToDiction.split_package(inputStr3)
    print_splited_string_and_nokori(newString, nokori)
    ...
    nokori, newString = TmJsonToDiction.split_package(inputStr4)
    print_splited_string_and_nokori(newString, nokori)
    ...
    nokori, newString = TmJsonToDiction.split_package(inputStr5)
    print_splited_string_and_nokori(newString, nokori)
    ...
    nokori, newString = TmJsonToDiction.split_package(inputStr6)
    print_splited_string_and_nokori(newString, nokori)
    ...
    nokori, newString = TmJsonToDiction.split_package(inputStr7)
    print_splited_string_and_nokori(newString, nokori)
    ...
    nokori, newString = TmJsonToDiction.split_package(inputStr8)
    print_splited_string_and_nokori(newString, nokori)
    ...
    nokori, newString = TmJsonToDiction.split_package(inputStr9)
    print_splited_string_and_nokori(newString, nokori)

    print('------test 10----<nokori>------')
    inputStr10 = '$TMSVR,228,0,3,[{"Item":'
    nokori, newString = TmJsonToDiction.split_package(inputStr10)
    print_splited_string_and_nokori(newString, nokori)
